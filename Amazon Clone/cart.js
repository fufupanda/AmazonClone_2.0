...
function generateCartItems(cartItems){
    ...
    cartItems.forEach((item) => {
        ...
        <div class="cart-item flex items-center pb-4 border-b border-gray-100">
                        ...
                        <div class="cart-items-details flex-grow">
                            <div class="cart-item-title font-bold text-sm text-gray-600 mt-2">
                            ${item.name}
                            </div>
                        ...
                        <div class="cart-items-counter w-48 flex items-center">
